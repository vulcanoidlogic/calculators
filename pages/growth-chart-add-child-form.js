...
class GrowthChartAddChildForm extends Component {
  constructor(props) {
    super(props);
...
export default withRedux(initStore, mapStateToProps, mapDispatchToProps)(withRoot(GrowthChartAddChildForm));
