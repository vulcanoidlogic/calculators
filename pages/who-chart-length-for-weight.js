...
import { WHO_LENGTH_FOR_WEIGHT } from 'common/constants';
...
class WhoChartLengthForWeight extends Component {
  constructor(props) {
    super(props);
  ...
  initDefns = props => {
    defnsParms.referrerPageCd = WHO_LENGTH_FOR_WEIGHT;
...
export default withRedux(initStore, mapStateToProps, mapDispatchToProps)(withRoot(WhoChartLengthForWeight));
