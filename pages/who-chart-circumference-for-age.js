...
import { WHO_CIRCUMFERENCE_FOR_AGE } from 'common/constants';
...
class WhoChartCircumferenceForAge extends Component {
  constructor(props) {
    super(props);
  ...
  initDefns = props => {
    defnsParms.referrerPageCd = WHO_CIRCUMFERENCE_FOR_AGE;
...
export default withRedux(initStore, mapStateToProps, mapDispatchToProps)(withRoot(WhoChartCircumferenceForAge));
