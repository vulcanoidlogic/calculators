...
import { CDC_WEIGHT_FOR_AGE } from 'common/constants';
...
class GrowthChartWeightForAge extends Component {
  constructor(props) {
    super(props);
  ...
  initDefns = props => {
    defnsParms.referrerPageCd = CDC_WEIGHT_FOR_AGE;
...
export default withRedux(initStore, mapStateToProps, mapDispatchToProps)(withRoot(GrowthChartWeightForAge));
