...
import { WHO_LENGTH_FOR_AGE } from 'common/constants';
...
class WhoChartLengthForAge extends Component {
  constructor(props) {
    super(props);
  ...
  initDefns = props => {
    defnsParms.referrerPageCd = WHO_LENGTH_FOR_AGE;
...
export default withRedux(initStore, mapStateToProps, mapDispatchToProps)(withRoot(WhoChartLengthForAge));
